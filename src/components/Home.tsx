                        ...
                        <SplitterPanel size={85}>
                            <Splitter>
                                ...
                                <SplitterPanel className="flex align-items-center justify-content-center" size={80}>
                                    <img src="https://images.unsplash.com/photo-1618365908648-e71bd5716cba?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" width={680} height={250} alt="" />
                                </SplitterPanel>
                            </Splitter>
                        </SplitterPanel>
                    </Splitter>
